    ...
    <section className="pt-[5rem] pb-16 relative mq-sections">
      ...
      <div className="mt-[5rem] flex flex-col gap-8 lg:flex-row">
        <div className="relative flex-1 flex flex-col gap-8">
          {firstHalfPortfolios.map((each) => {
            return (
              <Link href={`/portfolio/${each.link}`} key={each.id}>
                <motion.div
                  className={`flex flex-col items-center justify-center shadow-md rounded-lg h-[740px] ${each.bgColor}`}
